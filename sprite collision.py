...
background_image = pygame.transform.scale(pygame.image.load("penguin.jpg"), (SCREEN_WIDTH, SCREEN_HEIGHT))
...
class Sprite(pygame.sprite.Sprite):
    ...
    def move(self, x_change, y_change):
        self.rect.x = min(max(self.rect.x + x_change, 0), SCREEN_WIDTH - self.rect.width)
        self.rect.y = min(max(self.rect.y + y_change, 0), SCREEN_HEIGHT - self.rect.height)
